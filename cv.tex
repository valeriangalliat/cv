...
\begin{itemize}
  \item
    \private{23 avenue du Vercors, 38240 Meylan, France}
    \public{Grenoble, France}
  \item
    \en{2 years Working Holiday Visa for Canada from end of September 2015}
    \fr{Permis Vacances Travail de 2 ans au Canada débutant fin septembre 2015}
  \private{\item +33~7~81~29~21~54}
...
\begin{itemize}
  \item JavaScript (ES6/7, Node.js/io.js, \en{browser}\fr{navigateur})
  \item PHP
  \item SQL
  \item Python
  \item C
